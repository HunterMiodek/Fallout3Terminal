...
```bash
git clone https://github.com/HunterMiodek/FederalTerminalV14
chmod +x $HOME/FederalTerminalV14/terminalscript
cool-retro-term --fullscreen --noclose -e bash $HOME/FederalTerminalV14/terminalscript
```
