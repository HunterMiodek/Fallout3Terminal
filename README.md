...
```bash
git clone https://github.com/HunterMiodek/FederalTerminalV193
chmod +x $HOME/FederalTerminalV193/terminalscript
cool-retro-term --fullscreen --noclose -e bash $HOME/FederalTerminalV193/terminalscript
```
