...
```bash
git clone https://github.com/HunterMiodek/HFTerminal
chmod +x $HOME/HFTerminal/terminalscript
cool-retro-term --fullscreen --noclose -e bash $HOME/HFTerminal/terminalscript
```
