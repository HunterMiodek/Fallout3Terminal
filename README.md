...
```bash
git clone https://github.com/HunterMiodek/Terminal4
chmod +x $HOME/Terminal4/terminalscript
cool-retro-term --fullscreen --noclose -e bash $HOME/Terminal4/terminalscript
```
