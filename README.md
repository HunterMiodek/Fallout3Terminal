...
```bash
git clone https://github.com/HunterMiodek/FederalTerminalV18
chmod +x $HOME/FederalTerminalV18/terminalscript
cool-retro-term --fullscreen --noclose -e bash $HOME/FederalTerminalV18/terminalscript
```
