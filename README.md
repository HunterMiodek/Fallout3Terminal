...
```bash
git clone https://github.com/HunterMiodek/Terminal2
chmod +x $HOME/Terminal2/terminalscript
cool-retro-term --fullscreen --noclose -e bash $HOME/Terminal2/terminalscript
```
