...
```bash
git clone https://github.com/HunterMiodek/FederalTerminalV10
chmod +x $HOME/FederalTerminalV10/terminalscript
cool-retro-term --fullscreen --noclose -e bash $HOME/FederalTerminalV10/terminalscript
```
