...
```bash
git clone https://github.com/HunterMiodek/FederalTerminalV16
chmod +x $HOME/FederalTerminalV16/terminalscript
cool-retro-term --fullscreen --noclose -e bash $HOME/FederalTerminalV16/terminalscript
```
