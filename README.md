...
```bash
git clone https://github.com/HunterMiodek/FederalTerminalV195
chmod +x $HOME/FederalTerminalV195/terminalscript
cool-retro-term --fullscreen --noclose -e bash $HOME/FederalTerminalV195/terminalscript
```
