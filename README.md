...
```bash
git clone https://github.com/HunterMiodek/FederalTerminalV1
chmod +x $HOME/FederalTerminalV1/terminalscript
cool-retro-term --fullscreen --noclose -e bash $HOME/FederalTerminalV1/terminalscript
```
