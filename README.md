...
```bash
git clone https://github.com/HunterMiodek/FederalTerminalV199
chmod +x $HOME/FederalTerminalV199/terminalscript
cool-retro-term --fullscreen --noclose -e bash $HOME/FederalTerminalV199/terminalscript
```
