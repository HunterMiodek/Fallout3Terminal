...
```bash
git clone https://github.com/HunterMiodek/Terminal9
chmod +x $HOME/Terminal9/terminalscript
cool-retro-term --fullscreen --noclose -e bash $HOME/Terminal9/terminalscript
```
