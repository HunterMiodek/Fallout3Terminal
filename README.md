...
```bash
git clone https://github.com/HunterMiodek/FederalTerminalV197
chmod +x $HOME/FederalTerminalV197/terminalscript
cool-retro-term --fullscreen --noclose -e bash $HOME/FederalTerminalV197/terminalscript
```
