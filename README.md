...
```bash
git clone https://github.com/HunterMiodek/FederalTerminalV9
chmod +x $HOME/FederalTerminalV9/terminalscript
cool-retro-term --fullscreen --noclose -e bash $HOME/FederalTerminalV9/terminalscript
```
