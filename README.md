...
```bash
git clone https://github.com/HunterMiodek/FederalTerminalV1202
chmod +x $HOME/FederalTerminalV1202/terminalscript
cool-retro-term --fullscreen --noclose -e bash $HOME/FederalTerminalV1202/terminalscript
```
