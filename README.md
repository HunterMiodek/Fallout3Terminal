...
```bash
git clone https://github.com/HunterMiodek/FederalTerminalV12
chmod +x $HOME/FederalTerminalV12/terminalscript
cool-retro-term --fullscreen --noclose -e bash $HOME/FederalTerminalV12/terminalscript
```
