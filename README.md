...
```bash
git clone https://github.com/HunterMiodek/FederalTerminalV196
chmod +x $HOME/FederalTerminalV196/terminalscript
cool-retro-term --fullscreen --noclose -e bash $HOME/FederalTerminalV196/terminalscript
```
