...
```bash
git clone https://github.com/HunterMiodek/HFTerminalOS
chmod +x $HOME/HFTerminalOS/terminalscript
cool-retro-term --fullscreen --noclose -e bash $HOME/HFTerminalOS/terminalscript
```
