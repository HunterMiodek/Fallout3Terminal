...
```bash
git clone https://github.com/HunterMiodek/Terminal3
chmod +x $HOME/Terminal3/terminalscript
cool-retro-term --fullscreen --noclose -e bash $HOME/Terminal3/terminalscript
```
