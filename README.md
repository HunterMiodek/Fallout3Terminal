...
```bash
git clone https://github.com/HunterMiodek/FederalTerminalV8
chmod +x $HOME/FederalTerminalV8/terminalscript
cool-retro-term --fullscreen --noclose -e bash $HOME/FederalTerminalV8/terminalscript
```
