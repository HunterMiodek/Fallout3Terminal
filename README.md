...
```bash
git clone https://github.com/HunterMiodek/FederalTerminalV17
chmod +x $HOME/FederalTerminalV17/terminalscript
cool-retro-term --fullscreen --noclose -e bash $HOME/FederalTerminalV17/terminalscript
```
