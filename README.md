...
```bash
git clone https://github.com/HunterMiodek/Terminal18
chmod +x $HOME/Terminal8/terminalscript
cool-retro-term --fullscreen --noclose -e bash $HOME/Terminal18/terminalscript
```
