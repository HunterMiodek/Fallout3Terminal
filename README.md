...
```bash
git clone https://github.com/HunterMiodek/FederalTerminalV192
chmod +x $HOME/FederalTerminalV192/terminalscript
cool-retro-term --fullscreen --noclose -e bash $HOME/FederalTerminalV192/terminalscript
```
