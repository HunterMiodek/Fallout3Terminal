...
```bash
git clone https://github.com/HunterMiodek/FederalTerminalV19
chmod +x $HOME/FederalTerminalV19/terminalscript
cool-retro-term --fullscreen --noclose -e bash $HOME/FederalTerminalV19/terminalscript
```
