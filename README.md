...
```bash
git clone https://github.com/HunterMiodek/FederalTerminalV198
chmod +x $HOME/FederalTerminalV198/terminalscript
cool-retro-term --fullscreen --noclose -e bash $HOME/FederalTerminalV198/terminalscript
```
