...
```bash
git clone https://github.com/HunterMiodek/Terminal1
chmod +x $HOME/Terminal1/terminalscript
cool-retro-term --fullscreen --noclose -e bash $HOME/Terminal1/terminalscript
```
